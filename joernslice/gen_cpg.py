...
def gen_cpg_bin(code_path):
    ...
    for directory in tqdm(os.listdir(code_path), desc='Generating cpg'):
        ...
        cpg_output_path = f"/data/cpg_bin/{directory}"
...
if __name__ == '__main__':
    ...
    # gen_cpg_bin('/root/expdata/all_data')
    # gen_cpg_bin('/root/expdata/all_data_without_comment')

    # neo4jcsv_export('/root/joernSlice/data/cpg_bin')
    # list1 = os.listdir('/root/expdata/all_data')
    bin_path = '/data/cpg_bin'
